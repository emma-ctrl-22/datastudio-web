...
import { useSlowMovingItemsQuery } from '../../api/ReportService';
...
export function SlowMovingItemsReportPage() {
  ...
  const { data: slowMovingItems, isLoading, error } = useSlowMovingItemsQuery(filters, {
  ...
  return (
    <div className="p-4 md:p-0">
      <PageHeader title="Slow-Moving Items Report">
      ...
      <SharedTable<MoversReportItem>
        columns={columns}
        dataSource={slowMovingItems?.items || []}
        loading={isLoading}
        pagination={{
          current: filters.page,
          pageSize: filters.pageSize,
          total: slowMovingItems?.total || 0,
        }}
